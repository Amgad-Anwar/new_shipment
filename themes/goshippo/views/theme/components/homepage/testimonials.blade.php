            ...
            <div class="contents">
                <div class="app-carousel">
                    ...
                    <div class="card text-center bg-light">
                        ...
                        <footer class="footer">
                            @php
                                $button_type = isset($data['section_4_url']) ? $data['section_4_url']['type'] : '';
                            @endphp
                            <a href="{{ $data['section_4_url'][$button_type] ?? '' }}" style="{{ $buttonColor }}"
                                class="link">{{ $data['section_4_button'][app()->getLocale()] ?? '' }}</a>
                        </footer>
                    </div>
                    ...
                    <div class="card text-center bg-light">
                        ...
                        <footer class="footer">
                            @php
                                $button_type = isset($data['section_5_url']) ? $data['section_5_url']['type'] : '';
                            @endphp
