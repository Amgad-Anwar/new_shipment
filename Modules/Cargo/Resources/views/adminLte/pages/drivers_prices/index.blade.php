            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex flex-wrap align-items-center" id="{{ $table_id }}_custom_filter">
                    ...
                    <x-table-filter :table_id="$table_id" :filters="$filters">
                        ...
                        <!-- ================== begin State filter =============================== -->
                        @include('cargo::adminLte.pages.drivers_prices.table.filters', ['table_id' => $table_id, 'filters' => $filters])
                        <!-- ================== end State filter =============================== -->
                    ...
                    @if(auth()->user()->can('create-areas') || $user_role == $admin)
                        <a href="{{ fr_route('drivers_prices.create') }}" class="btn btn-primary m-1">{{ __('cargo::view.create') }}</a>
                    @endif
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
                ...
                {{-- @include('adminLte.components.modules.datatable.columns.checkbox-actions', [
                    ...
                    'url' => fr_route('drivers_prices.multi-destroy'),
